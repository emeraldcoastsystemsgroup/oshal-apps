...
exports.mjcfVec3 = exports.mjcfNumber = exports.RIGID_BODY_PLANT = exports.G_MPS2 = exports.GUARD_RING_M = exports.HULL_HALF_HEIGHT_M = exports.YAW_TORQUE_PER_THRUST_M = exports.MJCF_TIMESTEP_S = void 0;
exports.droneInertia = droneInertia;
exports.dronePlant = dronePlant;
exports.sceneGeoms = sceneGeoms;
exports.droneMjcf = droneMjcf;
...
function dronePlant(fit) {
    ...
    return {
        ...
        maxThrustPerMotorN: (d.sizing.thrustPerMotorTw2G / 1000) * exports.G_MPS2,
        hoverThrustPerMotorN: (d.sizing.thrustPerMotorHoverG / 1000) * exports.G_MPS2,
        hullHalfXyM: h + propR + exports.GUARD_RING_M,
        hullHalfZM: exports.HULL_HALF_HEIGHT_M,
        mastM: d.sensorSet.mastM, padPlateM: d.sensorSet.padPlateM, underDropM: d.sensorSet.underDropM,
        yawTorquePerThrustM: exports.YAW_TORQUE_PER_THRUST_M,
    };
}
...
const mjcfNumber = (v) => (Math.abs(v) < 1e-12 ? '0' : Number(v.toFixed(6)).toString());
exports.mjcfNumber = mjcfNumber;
/** @description One MJCF 3-vector. @param a - three numbers. @returns The attribute text. */
const mjcfVec3 = (a) => a.map(exports.mjcfNumber).join(' ');
exports.mjcfVec3 = mjcfVec3;
const f = exports.mjcfNumber;
const v3 = exports.mjcfVec3;
 ...
 */
function droneMjcf(fit, solids, home, medium) {
    const m = medium ?? (0, medium_1.mediumById)('vacuum');
    (0, medium_1.requireModelValidIn)(exports.RIGID_BODY_PLANT, m);
  ...
  <option timestep="${exports.MJCF_TIMESTEP_S}" gravity="${v3(m.gravityMps2)}" integrator="implicitfast"/>
  <default>
