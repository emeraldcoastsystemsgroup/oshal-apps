...
exports.centrePlate = centrePlate;
exports.arm = arm;
exports.guardSegment = guardSegment;
exports.mast = mast;
exports.tofMount = tofMount;
exports.batteryTray = batteryTray;
exports.landingFoot = landingFoot;
 ...
 * @returns The layout.
 */
function layoutFor(propIn, mastMm, tipGapMm = 30) {
...
const hole = (id, x, y, diameter = M3_CLEARANCE, label) => ({ id, type: 'hole', params: { diameter, x, y, axis: 'z' }, ...(label ? { label } : {}) });
...
function centrePlate(l) {
    ...
    const r1 = 52 / Math.SQRT2;
    const r2 = 62 / Math.SQRT2;
    [[1, 1], [1, -1], [-1, 1], [-1, -1]].forEach(([sx, sy], i) => {
...
function guardSegment(l) {
    const rIn = l.propDiameterMm / 2 + 9;
    const rOut = rIn + 3;
    const pts = [];
    const n = 24;
    for (let i = 0; i <= n; i += 1) {
...
//# sourceMappingURL=airframe.js.map