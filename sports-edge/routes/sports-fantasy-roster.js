 ...
 */
function historyFor(rows, scoring) {
    ...
    for (const [playerId, weeks] of byPlayer) {
        out.set(playerId, [...weeks]
            ...
            .map((w) => (0, sports_fantasy_scoring_1.applyScoring)(w.stats, scoring)));
    }
    return out;
}
/**
 ...
 */
function joinRoster(entries, projections, history) {
...
//# sourceMappingURL=sports-fantasy-roster.js.map