...
| **Portrait Studio** | [`portrait-studio/`](portrait-studio/) | 1.15.0 | ready | Create portraits from camera or uploaded photos with presets and backdrops. |
...
| **Video Studio** | [`video/`](video/) | 1.5.0 | ready | Make prompted short-form videos (TikTok / YouTube Shorts / Instagram Reels) from an idea - the director bot storyboards it and the studio renders a real .mp4 with voiceover and captions, saved to your Files storage; a series is written by the screenplay-writer, approval-gated on the script, then rendered one episode at a time on the remote Vids node. |
