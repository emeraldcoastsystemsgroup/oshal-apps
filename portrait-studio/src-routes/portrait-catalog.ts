...
import { PROFESSIONAL_PRESETS, CHARACTER_PRESETS } from './portrait-presets';
...
export { PROFESSIONAL_PRESETS, CHARACTER_PRESETS } from './portrait-presets';
...
export function findStyle(mode: string, presetId: string): PortraitPreset | null {
  const list = mode === 'professional' ? PROFESSIONAL_PRESETS : CHARACTER_PRESETS;
