 ...
 * -----------------------------------------------------------------------------
 * 2 | maintainer@emeraldcoastsystemsgroup.com   | The firmware runner files (firmware/) join the hash.
 * 1 | maintainer@emeraldcoastsystemsgroup.com   | Initial creation — the build hash of this package's engine
 *                     |                             | tree, computed EXACTLY as engine/container/circuit_engine_bridge.py
 ...
 * 3 | maintainer@emeraldcoastsystemsgroup.com   | firmware/cosim.py joins the hashed runtime files.
 */
...
export const RUNTIME_FILES = ['circuit_worker.py', 'circuit_parts.py', 'container/circuit_engine_bridge.py', 'container/Dockerfile', 'firmware/arduino_build.py', 'firmware/avr8js_run.js', 'firmware/cosim.py'] as const;
