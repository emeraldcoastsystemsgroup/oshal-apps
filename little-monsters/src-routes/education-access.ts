...
/** @description The parts of `req.oidc` an issuer decision reads; every trusted rail attaches this shape. */
export interface OidcIssuerSession {
  user?: { iss?: unknown } | null;
  idTokenClaims?: { iss?: unknown } | null;
}
 ...
 */
export function resolveSessionIssuer(oidc: OidcIssuerSession | null | undefined): string | null {
  if (!oidc) return null;
