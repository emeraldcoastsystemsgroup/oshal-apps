...
exports.TRANSPORTS = exports.DEFAULT_PATH_LOSS_EXPONENT = void 0;
exports.findTransport = findTransport;
exports.interceptDb = interceptDb;
exports.pathLossDb = pathLossDb;
exports.marginDb = marginDb;
exports.rangeAtMarginM = rangeAtMarginM;
exports.linkBudget = linkBudget;
exports.compareTransports = compareTransports;
...
exports.DEFAULT_PATH_LOSS_EXPONENT = 2.2;
 ...
 */
function findTransport(id) {
    return exports.TRANSPORTS.find((t) => t.id === id) ?? null;
}
/**
 ...
 */
function pathLossDb(t, distanceM, exponent = exports.DEFAULT_PATH_LOSS_EXPONENT) {
 ...
 */
function marginDb(t, distanceM, exponent = exports.DEFAULT_PATH_LOSS_EXPONENT) {
 ...
 */
function rangeAtMarginM(t, requiredMarginDb, exponent = exports.DEFAULT_PATH_LOSS_EXPONENT) {
 ...
 * @returns The budget.
 */
function linkBudget(t, distanceM, requiredMarginDb, exponent = exports.DEFAULT_PATH_LOSS_EXPONENT) {
 ...
 */
function compareTransports(distanceM, requiredMarginDb, exponent = exports.DEFAULT_PATH_LOSS_EXPONENT) {
    return exports.TRANSPORTS.map((t) => linkBudget(t, distanceM, requiredMarginDb, exponent));
}
function round1(v) {
