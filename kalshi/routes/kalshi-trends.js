...
exports.MIN_GRADED_FOR_VERDICT = exports.ROLLING_WINDOW = void 0;
...
async function trendSeries(pool, opts) {
    ...
    return { generatedAt: new Date(nowMs).toISOString(), windowDays: opts.sinceDays, minGraded: exports.MIN_GRADED_FOR_VERDICT, strategies, books };
}
