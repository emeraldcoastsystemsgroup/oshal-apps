...
# Kid Lens (`youtube-kids`) - database schema
...
**Created at runtime by package code** (`CREATE TABLE IF NOT EXISTS`): `routes/youtube-kids-routes.js`, `src-routes/youtube-kids-routes.ts`
...
Defined in `routes/youtube-kids-routes.js`, `src-routes/youtube-kids-routes.ts` · RLS **forced** - owner `user_sub`
