...
function simplifyChain(points: Point2D[], epsilon: number): Point2D[] {
 ...
 */
export function simplifyPolygon(loop: Point2D[], epsilon: number): Point2D[] {
 ...
 */
export function simplifyToBudget(loop: Point2D[], epsilon: number, maxPoints: number): { loop: Point2D[]; epsilon: number } {
