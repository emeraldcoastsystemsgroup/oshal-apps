...
import { buildUtmUrl, scorecardRollup, weekStartOf } from './marketing-model';
import {
  DATE_RE, EXPERIMENT_TRANSITIONS, UUID_RE, logger, rows, safeRows, type QueryablePool,
 ...
 */
export async function getScorecard(ctx: AppContext, sub: string, req: Request, res: Response): Promise<void> {
 ...
 * @returns Resolves when the response is sent.
 */
export async function rebuildScorecard(ctx: AppContext, sub: string, _req: Request, res: Response): Promise<void> {
 ...
 * @returns Resolves when the response is sent.
 */
export async function createExperiment(ctx: AppContext, sub: string, req: Request, res: Response): Promise<void> {
 ...
 * @returns Resolves when the response is sent.
 */
export async function patchExperiment(ctx: AppContext, sub: string, req: Request, res: Response): Promise<void> {
 ...
 * @returns Resolves when the response is sent.
 */
export async function decideBudgetProposal(ctx: AppContext, sub: string, req: Request, res: Response): Promise<void> {
  const id = String(req.params.id || '');
 ...
 * @returns Resolves when the response is sent.
 */
export async function getUtm(_ctx: AppContext, _sub: string, req: Request, res: Response): Promise<void> {
