...
exports.DEDUCTION_CODES = exports.EARNINGS_CODES = void 0;
exports.earningsCode = earningsCode;
exports.deductionCode = deductionCode;
exports.garnishmentCodesByPriority = garnishmentCodesByPriority;
/** Every earnings code the engine understands. */
exports.EARNINGS_CODES = {
    REG: {
...
function earningsCode(code) {
    return exports.EARNINGS_CODES[String(code || '').toUpperCase()] || null;
}
/** Look up a deduction code, or null when unknown. */
function deductionCode(code) {
    return exports.DEDUCTION_CODES[String(code || '').toUpperCase()] || null;
}
/** All garnishment codes, in the statutory order they must be applied. */
function garnishmentCodesByPriority() {
    return Object.values(exports.DEDUCTION_CODES)
        .filter((d) => d.garnishmentPriority !== undefined)
        .sort((a, b) => (a.garnishmentPriority || 0) - (b.garnishmentPriority || 0));
}
//# sourceMappingURL=payroll-codes.js.map