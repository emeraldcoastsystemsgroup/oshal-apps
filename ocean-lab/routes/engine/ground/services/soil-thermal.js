...
exports.WET_CLAY_SOIL = exports.DRY_SAND_SOIL = exports.DEFAULT_SOIL = exports.DEFAULT_GEOTHERMAL_GRADIENT_KM = exports.DIURNAL_PERIOD_S = exports.ANNUAL_PERIOD_S = void 0;
exports.dampingDepthM = dampingDepthM;
exports.soilTempC = soilTempC;
exports.junctionDeltaTK = junctionDeltaTK;
/** @description Period of the annual surface temperature wave, seconds (365.25 d). */
exports.ANNUAL_PERIOD_S = 31_557_600;
/** @description Period of the diurnal surface temperature wave, seconds. */
exports.DIURNAL_PERIOD_S = 86_400;
/**
 ...
 */
exports.DEFAULT_GEOTHERMAL_GRADIENT_KM = 0.025;
/**
 ...
 */
function dampingDepthM(thermalDiffusivityM2S, periodS) {
    if (!(thermalDiffusivityM2S > 0))
        throw new Error(`thermal diffusivity must be positive, got ${thermalDiffusivityM2S}`);
    if (!(periodS > 0))
        throw new Error(`wave period must be positive, got ${periodS}`);
 ...
 */
function waveTermC(amplitudeC, dampingM, depthM, periodS, tSeconds, phaseDeg) {
 ...
 */
function soilTempC(soil, depthM, tSeconds) {
    const alpha = soil.thermalDiffusivityM2S;
    const annual = waveTermC(soil.annualAmplitudeC, dampingDepthM(alpha, exports.ANNUAL_PERIOD_S), depthM, exports.ANNUAL_PERIOD_S, tSeconds, soil.annualPhaseDeg ?? 0);
    const diurnal = waveTermC(soil.diurnalAmplitudeC, dampingDepthM(alpha, exports.DIURNAL_PERIOD_S), depthM, exports.DIURNAL_PERIOD_S, tSeconds, soil.diurnalPhaseDeg ?? 0);
    const geothermal = (soil.geothermalGradientKM ?? exports.DEFAULT_GEOTHERMAL_GRADIENT_KM) * depthM;
 ...
 */
function junctionDeltaTK(soil, hotDepthM, coldDepthM, tSeconds) {
...
exports.DEFAULT_SOIL = {
    ...
    annualAmplitudeC: 12,
    diurnalAmplitudeC: 8,
    geothermalGradientKM: exports.DEFAULT_GEOTHERMAL_GRADIENT_KM,
};
/**
