/** The existing route factory supplies its live in-memory simulator registry. */
...
export function satHomeSummary(fleet: SatFleetSummary[], catalog: TleCatalogEntry[], now=Date.now()) {
