...
const trading_earnings_rule_routes_1 = require("./trading-earnings-rule-routes");
...
function createTradingRoutes(ctx) {
    ...
    (0, trading_earnings_rule_routes_1.registerTradingEarningsRuleRoutes)(router, ctx);
