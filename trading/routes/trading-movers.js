...
exports.MOVER_KINDS = void 0;
exports.isMoverKind = isMoverKind;
exports.computeMovers = computeMovers;
/** The valid `?kind=` values, in a stable order. */
exports.MOVER_KINDS = ['winners', 'losers', 'volatile', 'active'];
 ...
 */
function isMoverKind(x) {
    return typeof x === 'string' && exports.MOVER_KINDS.includes(x);
}
/**
 ...
 */
function volatilityPctOf(bars) {
    if (bars.length < VOL_MIN_BARS)
        return null;
 ...
 */
function computeMovers(barsBySymbol, kind, limit) {
    const rows = [];
...
//# sourceMappingURL=trading-movers.js.map