...
import {
  DEFAULT_UNIVERSE, barsBatchOhlcv, fundamentalsSummary, getMarketData, recentNews, searchSymbols,
  type Fundamentals, type NewsItem, type TradingBook,
...
import { computeMovers, isMoverKind, type MoverKind, type MoverRow } from './trading-movers';
import {
 ...
 */
async function withNames(rows: MoverRow[]): Promise<MoverRow[]> {
