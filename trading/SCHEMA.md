...
# Intelligent Trades (`trading`) - database schema
...
**Created at runtime by package code** (`CREATE TABLE IF NOT EXISTS`): `routes/trading-research-routes.js`, `src-routes/trading-research-routes.ts`
...
Defined in `routes/trading-research-routes.js`, `src-routes/trading-research-routes.ts` · RLS **forced** - owner `user_sub`
