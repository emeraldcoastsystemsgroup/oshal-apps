...
exports.DOC_KEYS = exports.DOC_CATALOG = void 0;
exports.getDocSpec = getDocSpec;
exports.proseKeysFor = proseKeysFor;
exports.requiredFigureIds = requiredFigureIds;
/** The seventeen documents, in reading order. */
exports.DOC_CATALOG = Object.freeze([
    {
...
exports.DOC_KEYS = Object.freeze(exports.DOC_CATALOG.map((d) => d.key));
/**
 ...
 */
function getDocSpec(key) {
    return exports.DOC_CATALOG.find((d) => d.key === key) ?? null;
}
/**
 ...
 */
function proseKeysFor(spec) {
    return spec.sections.filter((s) => s.kind === 'prose')
        .map((s) => s.proseKey);
}
/**
 ...
 */
function requiredFigureIds(spec) {
    const ids = new Set();
...
for (const spec of exports.DOC_CATALOG) {
...
//# sourceMappingURL=venture-doc-catalog.js.map